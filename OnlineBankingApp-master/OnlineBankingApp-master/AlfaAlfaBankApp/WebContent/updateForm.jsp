...
<body>
	<form action="updated.app" method="get">
		...
		<table align="center" cellspacing="8" border="2">
			<tr>
				...
				<td><input type="text" name="accountNumber" readonly="readonly" value="${sessionScope.bankAccount.accountNumber}"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="customerId" readonly="readonly" value="${sessionScope.bankAccount.accountHolder.customerId}"></td>
			</tr>
			<tr>
				<td align="center">Email</td>
				<td><input type="emailId" name="emailId" required="required" placeholder="${sessionScope.bankAccount.accountHolder.emailId}"></td>
			</tr>
			<tr>
